...
import bgImage from "../../../public/assets/images/getintouch_bg.jpg";

const GetInTouch = () => {
    const touchContent = {
        subtitle: 'Get In Touch',
        title: 'Free Consultation',
        title2: 'We’re Here To  Support And Connect With You',
        des: 'Whether It’s A Query, Feedback, Or a Project Proposal, We’re Just A Call Or Email Away. Your Journey Starts With a Conversation!',
    }
    return (
        <>
            <div className="getIn__touch section-padding" style={{ backgroundImage: `url(${bgImage.src})` }}>
                ...
                <div className="get_in_touch_overlay"></div>
                            ...
                            <div className="getIn__touch-left">
                                ...
                                <div className="getIn__touch-left-form">
                                    <form action="#">
                                        ...
                                        <div className="mt-25">
                                            <button className="btn-one theme-btn one" type="submit">Free Consulting</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div className="getIn__touch-right">
                                ...
                                <div className="getIn__touch-right-bottom">
                                    ...
                                    <div className="getIn__touch-right-bottom-shape">
                                        <img src="assets/images/arrow.png" alt="shape" />
                                    </div>
                                    <div className="getIn__touch-right-bottom-image">
                                        <ul>
                                            <li><img src="assets/images/avatar/avatar4.png" alt="avatar" /></li>
                                            <li><img src="assets/images/avatar/avatar3.png" alt="avatar" /></li>
                                            <li><img src="assets/images/avatar/avatar2.png" alt="avatar" /></li>
                                            <li><img src="assets/images/avatar/avatar-1.png" alt="avatar" /></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="help__area">
                            ...
                            <div className="help__area-item">
                                <div className="help__area-item-icon">
                                    {/* <i className="fal fa-envelope-open-text"></i> */}
                                    <div className="customicons">
                                        <span className="fa fa-inbox fa-2x" />
                                    </div>

                                </div>
                                <div className="help__area-item-info">
                                    <span className="text-three">Email drop Us</span>
                                    <h5><Link href="mailto:hello@nidham.us">hello@nidham.us</Link></h5>
                                </div>
                            </div>
                        </div>
                    </div>
