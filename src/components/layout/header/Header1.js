                            ...
                            <div className="col-lg-2 col-md-9 col-sm-9 col-xs-9 logo_column">
                                <div className="header_logo_box">
                                    <Link href="/" className="logo navbar-brand">
                                        <img src="/assets/images/logo-default.png" alt="Nidham Consultancy LLC" className="logo_default" />
                                        <img src="/assets/images/logo-default.png" alt="Nidham Consultancy" className="logo__sticky" />
                                    </Link>
                                </div>
                            </div>
                                    ...
                                    <div className="header_right_content">
                                        <ul>
                                            ...
                                            <li className="header-button">
                                                <Link href="#" onClick={handleContactPopup} className="theme-btn one"> Get In Touch
                                                </Link>
                                            </li>
                                            {/* <li>
