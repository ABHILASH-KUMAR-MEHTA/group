                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-7 col-md-12 about_company_inner">
                                <div className="abt_content">
                                    ...
                                    <div className="text">
                                        <p> From AI-powered innovation to cutting-edge cybersecurity, from financial expertise to creative branding, we deliver strategic solutions that drive your business forward.</p>
                                    ...
                                    <div className="copright">
                                        © {new Date().getFullYear()} nidham-us. All Rights Reserved.
                                    </div>
                                </div>
                            </div>
                        </div>
