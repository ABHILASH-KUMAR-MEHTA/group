                                    ...
                                    <div className="contact_box_content style_one">
                                        <div className="contact_box_inner icon_yes">
                                            ...
                                            <div className="contnet">
                                                <h3> Post Address </h3>
                                                <p>
                                                <Link href="https://maps.app.goo.gl/yP1xJyT16PeKCBvWA">Nidham Consultancy LLC, SHAMS ,UAE</Link>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="contact_box_content style_one">
                                        <div className="contact_box_inner icon_yes">
                                            ...
                                            <div className="contnet">
                                                ...
                                                <p>
                                                    Phone: <Link href="tel:+9806071234">+98 060 712 34</Link> &amp; Email: <Link href="mailto:hello@nidham.us">hello@nidham.us</Link>
                                                    {/* Phone: +98 060 712 34 &amp; */}
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="contact_box_content style_one">
                                        <div className="contact_box_inner icon_yes">
                                            ...
                                            <div className="contnet">
                                                ...
                                                <p>
                                                    Mon-Fri: 09:00AM to 05:00PM (Sat &amp; Sun: Closed)
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="col-lg-12">
                                    <section className="map-section">
                                        ...
                                        <div className="map-outer">
                                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3607.7663082244744!2d55.67571487538441!3d25.27844557765873!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ef5929a229f1c75%3A0xb28ae30eb6bb813a!2sSharjah%20Media%20City%20(Shams)!5e0!3m2!1sen!2sae!4v1734638947861!5m2!1sen!2sae" height={570} style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
                                        </div>
                                    </section>
                                </div>
                            </div>
