...
export default function ServiceDetails() {
    ...
    return (
        <>
            <Layout breadcrumbTitle="Cloud Solutions">
                <div>
                                    ...
                                    <article className="clearfix service type-service status-publish has-post-thumbnail hentry">
                                        <div className="title_all_box style_one dark_color">
                                            <div className="title_sections left">
                                                <div className="before_title">Empowering Businesses with Scalable and Flexible Cloud Technology</div>
                                                {/* <div className="title">Our Service</div> */}
                                                <p>At Nidham Consultancy LLC, we specialize in providing cutting-edge cloud solutions that enable businesses to operate seamlessly from anywhere. Our services ensure flexibility, scalability, and efficiency, allowing organizations to focus on core operations while leveraging the power of the cloud.
                                                </p>
                                            </div>
                                        </div>
                                        <div className="row no-space">
                                            <div className="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-5 mb-lg-5 mb-xl-0 ps-0 ps-lg-0 pe-0 pe-lg-0 pe-xl-3">
                                                ...
                                                <div className="icon_box_all style_one">
                                                    <div className="icon_content ">
                                                        ...
                                                        <div className="txt_content">
                                                            <h3>
                                                                <Link href="#" >
                                                                    Enhanced Accessibility</Link>
                                                            </h3>
                                                            <p>Access your systems and data securely from anywhere, enabling greater flexibility and collaboration.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                {/*===============spacing==============*/}
                                                ...
                                                <div className="simple_image_boxes">
                                                    <img src="/assets/images/cloud-technology.jpg" className="object-fit-cover-center height_570px" alt="image" />
                                                </div>
                                            </div>
                                            <div className="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-xs-12 ps-0 ps-lg-0 pe-0 pe-lg-0 ps-xl-3">
                                                <div className="icon_box_all style_one">
                                                    <div className="icon_content ">
                                                        ...
                                                        <div className="txt_content">
                                                            <h3>
                                                                <Link href="#" >Scalable Infrastructure</Link>
                                                            </h3>
                                                            <p>Scale your IT resources effortlessly to match your growing business needs without additional overhead.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                {/*===============spacing==============*/}
                                                ...
                                                <div className="icon_box_all style_one">
                                                    <div className="icon_content ">
                                                        ...
                                                        <div className="txt_content">
                                                            <h3>
                                                                <Link href="#" >Cost-Effective Operations</Link>
                                                            </h3>
                                                            <p>Reduce IT expenses by shifting to a pay-as-you-go model with cloud-based solutions.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                {/*===============spacing==============*/}
                                                ...
                                                <div className="content_box_cn style_one">
                                                    <div className="txt_content">
                                                        <h3>
                                                            <Link href="#" >Assessing Business Needs</Link>
                                                        </h3>
                                                        <p>Begin with a thorough evaluation of your current IT setup and cloud requirements to design an optimal solution.</p>
                                                    </div>
                                                </div>
                                                <div className="content_box_cn  style_one">
                                                    <div className="txt_content">
                                                        <h3>
                                                            <Link href="#" >Implementing Tailored Cloud Solutions</Link>
                                                        </h3>
                                                        <p>Deploy customized cloud services, ensuring a seamless transition and integration into existing systems.
                                                        </p>
                                                    </div>
                                                </div>
                                                <div className="content_box_cn  style_one">
                                                    <div className="txt_content">
                                                        <h3>
                                                            <Link href="#" >Ongoing Monitoring and Support</Link>
                                                        </h3>
                                                        <p>Provide continuous support, monitoring, and optimization to maximize the value of your cloud investments.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="widgets_grid_box">
                                        <div className="widget creote_widget_service_list">
                                            ...
                                            <ul className="service_list_box">
                                                <li><Link href="#">1. Colocation and Hosted Data Centers</Link> </li>
                                                <li><Link href="#">2. Infrastructure as a Service (IaaS)</Link> </li>
                                                <li><Link href="#">3. Email Services (Microsoft 365 and Google Workspace)</Link> </li>
                                                <li><Link href="#">4. Software Solutions</Link> </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div className="widgets_grid_box">
