...
export default function ServiceDetails() {
    ...
    return (
        <>
            <Layout breadcrumbTitle="Finance & Tax Consultancy">
                <div>
                                    ...
                                    <article className="clearfix service type-service status-publish has-post-thumbnail hentry">
                                        <div className="title_all_box style_one dark_color">
                                            <div className="title_sections left">
                                                <div className="before_title">Optimize Your Finances with Tailored Solutions</div>
                                                {/* <div className="title">Our Service</div> */}
                                                <p>At Nidham Consultancy LLC, we specialize in providing expert financial and tax consultancy services. From managing complex financial structures to ensuring compliance with evolving tax regulations, we empower businesses to achieve financial stability and efficiency.
                                                </p>
                                            </div>
                                        </div>
                                        <div className="row no-space">
                                            <div className="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-5 mb-lg-5 mb-xl-0 ps-0 ps-lg-0 pe-0 pe-lg-0 pe-xl-3">
                                                ...
                                                <div className="icon_box_all style_one">
                                                    <div className="icon_content ">
                                                        ...
                                                        <div className="txt_content">
                                                            <h3>
                                                                <Link href="#" >Comprehensive Financial Oversight</Link>
                                                            </h3>
                                                            <p>Maintain accurate records, detailed reporting, and executive-level financial management.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                {/*===============spacing==============*/}
                                                ...
                                                <div className="simple_image_boxes">
                                                    <img src="/assets/images/finance-solutions.jpg" className="object-fit-cover-center height_570px" alt="image" />
                                                </div>
                                            </div>
                                            <div className="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-xs-12 ps-0 ps-lg-0 pe-0 pe-lg-0 ps-xl-3">
                                                <div className="icon_box_all style_one">
                                                    <div className="icon_content ">
                                                        ...
                                                        <div className="txt_content">
                                                            <h3>
                                                                <Link href="#" >Cash Flow Management & Financial Planning</Link>
                                                            </h3>
                                                            <p>Streamline your finances to improve cash flow and plan for sustainable growth.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                {/*===============spacing==============*/}
                                                ...
                                                <div className="icon_box_all style_one">
                                                    <div className="icon_content ">
                                                        ...
                                                        <div className="txt_content">
                                                            <h3>
                                                                <Link href="#" >Tax Structuring, Compliance & Optimization</Link>
                                                            </h3>
                                                            <p>Ensure compliance while minimizing tax liabilities through strategic tax planning.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                {/*===============spacing==============*/}
                                                ...
                                                <div className="content_box_cn style_one">
                                                    <div className="txt_content">
                                                        <h3>
                                                            <Link href="#" >Understanding Financial Needs</Link>
                                                        </h3>
                                                        <p>Analyze your existing financial processes, cash flow challenges, and compliance requirements to identify key areas for improvement.</p>
                                                    </div>
                                                </div>
                                                <div className="content_box_cn  style_one">
                                                    <div className="txt_content">
                                                        <h3>
                                                            <Link href="#" >Developing Tailored Strategies</Link>
                                                        </h3>
                                                        <p>Craft customized financial and tax solutions aligned with your business goals, ensuring operational efficiency.
                                                        </p>
                                                    </div>
                                                </div>
                                                <div className="content_box_cn  style_one">
                                                    <div className="txt_content">
                                                        <h3>
                                                            <Link href="#" >Implementing and Monitoring</Link>
                                                        </h3>
                                                        <p>Provide hands-on implementation, regular evaluations, and ongoing support to adapt to your evolving business needs.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="widgets_grid_box">
                                        <div className="widget creote_widget_service_list">
                                            ...
                                            <ul className="service_list_box">
                                                <li><Link href="#">1. Bookkeeping, Financial Reporting & CFO Support</Link> </li>
                                                <li><Link href="#">2. Cash Flow Management & Financial Planning</Link> </li>
                                                <li><Link href="#">3. Tax Structuring, Compliance & Optimization</Link> </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div className="widgets_grid_box">
