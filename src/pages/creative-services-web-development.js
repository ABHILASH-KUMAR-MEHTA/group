...
export default function ServiceDetails() {
    ...
    return (
        <>
            <Layout breadcrumbTitle="Creative Services & Web Development">
                <div>
                                    ...
                                    <article className="clearfix service type-service status-publish has-post-thumbnail hentry">
                                        <div className="title_all_box style_one dark_color">
                                            <div className="title_sections left">
                                                <div className="before_title">Transforming Ideas into Impactful Digital Experiences</div>
                                                {/* <div className="title">Our Service</div> */}
                                                <p>At Nidham Consultancy LLC, we specialize in delivering creative services that bring your brand to life and elevate your digital presence. From branding to web development and content creation, we help businesses connect with their audience effectively and drive meaningful engagement.
                                                </p>
                                            </div>
                                        </div>
                                        <div className="row no-space">
                                            <div className="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-5 mb-lg-5 mb-xl-0 ps-0 ps-lg-0 pe-0 pe-lg-0 pe-xl-3">
                                                ...
                                                <div className="icon_box_all style_one">
                                                    <div className="icon_content ">
                                                        ...
                                                        <div className="txt_content">
                                                            <h3>
                                                                <Link href="#" >Innovative Branding Solutions</Link>
                                                            </h3>
                                                            <p>Develop a cohesive and impactful brand identity that leaves a lasting impression.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                {/*===============spacing==============*/}
                                                ...
                                                <div className="simple_image_boxes">
                                                    <img src="/assets/images/web.png" className="object-fit-cover-center height_570px" alt="image" />
                                                </div>
                                            </div>
                                            <div className="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-xs-12 ps-0 ps-lg-0 pe-0 pe-lg-0 ps-xl-3">
                                                <div className="icon_box_all style_one">
                                                    <div className="icon_content ">
                                                        ...
                                                        <div className="txt_content">
                                                            ...
                                                            <p>Create dynamic, user-friendly websites that seamlessly blend aesthetics with functionality.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                {/*===============spacing==============*/}
                                                ...
                                                <div className="icon_box_all style_one">
                                                    <div className="icon_content ">
                                                        ...
                                                        <div className="txt_content">
                                                            <h3>
                                                                <Link href="#" >Strategic Marketing Campaigns</Link>
                                                            </h3>
                                                            <p>Plan and execute targeted campaigns to maximize reach and drive measurable results.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                {/*===============spacing==============*/}
                                                ...
                                                {/*===============spacing==============*/}
                                                <div className="description_box">
                                                    <p>Our approach ensures seamless creative solutions and web development excellence.</p>
                                                </div>
                                                {/*===============spacing==============*/}
                                                <div className="pd_bottom_25" />
                                                {/*===============spacing==============*/}
                                                <div className="content_box_cn style_one">
                                                    <div className="txt_content">
                                                        <h3>
                                                            <Link href="#" >Understanding Your Vision</Link>
                                                        </h3>
                                                        <p>We begin by immersing ourselves in your brand and understanding your goals to create a tailored strategy.</p>
                                                    </div>
                                                </div>
                                                <div className="content_box_cn  style_one">
                                                    <div className="txt_content">
                                                        <h3>
                                                            <Link href="#" >Crafting Unique Solutions</Link>
                                                        </h3>
                                                        <p>Design and develop creative assets, websites, and campaigns that align with your business objectives.</p>
                                                    </div>
                                                </div>
                                                <div className="content_box_cn  style_one">
                                                    <div className="txt_content">
                                                        <h3>
                                                            <Link href="#" >Continuous Enhancement</Link>
                                                        </h3>
                                                        <p>Provide ongoing support and optimization to ensure your brand stays relevant and impactful in a competitive landscape.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="widgets_grid_box">
                                        <div className="widget creote_widget_service_list">
                                            ...
                                            <ul className="service_list_box">
                                                <li><Link href="#">1. Branding & Identity Design</Link> </li>
                                                <li><Link href="#">2. Website Design & Development</Link> </li>
                                                <li><Link href="#">3. Advertising & Marketing Campaigns</Link> </li>
                                                <li><Link href="#">4. Creative Consulting & Content Development</Link> </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div className="widgets_grid_box">
