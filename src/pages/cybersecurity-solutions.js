...
export default function ServiceDetails() {
    ...
    return (
        <>
            <Layout breadcrumbTitle="Cybersecurity Solutions">
                <div>
                                    ...
                                    <article className="clearfix service type-service status-publish has-post-thumbnail hentry">
                                        <div className="title_all_box style_one dark_color">
                                            <div className="title_sections left">
                                                <div className="before_title">Securing Your Digital Ecosystem with Advanced Protection</div>
                                                {/* <div className="title">Our Service</div> */}
                                                <p>At Nidham Consultancy LLC, we provide comprehensive cybersecurity services to safeguard your computer systems, networks, and data from digital threats. Leveraging cutting-edge technologies, our solutions are designed to ensure resilience, reliability, and rapid recovery in the face of any cyber incident.
                                                </p>
                                            </div>
                                        </div>
                                        <div className="row no-space">
                                            <div className="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-5 mb-lg-5 mb-xl-0 ps-0 ps-lg-0 pe-0 pe-lg-0 pe-xl-3">
                                                ...
                                                <div className="icon_box_all style_one">
                                                    <div className="icon_content ">
                                                        ...
                                                        <div className="txt_content">
                                                            <h3>
                                                                <Link href="#" >
                                                                    Proactive Threat Detection</Link>
                                                            </h3>
                                                            <p>Stay ahead of cyberattacks with continuous monitoring and advanced threat identification tools.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                {/*===============spacing==============*/}
                                                ...
                                                <div className="simple_image_boxes">
                                                    <img src="/assets/images/cybersecurity-solutions.jpg" className="object-fit-cover-center height_570px" alt="image" />
                                                </div>
                                            </div>
                                            <div className="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-xs-12 ps-0 ps-lg-0 pe-0 pe-lg-0 ps-xl-3">
                                                <div className="icon_box_all style_one">
                                                    <div className="icon_content ">
                                                        ...
                                                        <div className="txt_content">
                                                            <h3>
                                                                <Link href="#" >Resilient Data Recovery</Link>
                                                            </h3>
                                                            <p>Ensure business continuity with rapid incident response and industry-leading recovery solutions.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                {/*===============spacing==============*/}
                                                ...
                                                <div className="icon_box_all style_one">
                                                    <div className="icon_content ">
                                                        ...
                                                        <div className="txt_content">
                                                            <h3>
                                                                <Link href="#" >End-to-End Security Framework</Link>
                                                            </h3>
                                                            <p>Implement holistic security measures across all systems, ensuring consistent protection and compliance.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                {/*===============spacing==============*/}
                                                ...
                                                <div className="content_box_cn style_one">
                                                    <div className="txt_content">
                                                        <h3>
                                                            <Link href="#" >Assessing Vulnerabilities</Link>
                                                        </h3>
                                                        <p>Begin with a detailed analysis of your IT infrastructure to identify risks and potential vulnerabilities.</p>
                                                    </div>
                                                </div>
                                                <div className="content_box_cn  style_one">
                                                    <div className="txt_content">
                                                        <h3>
                                                            <Link href="#" >Implementing Customized Solutions</Link>
                                                        </h3>
                                                        <p>Deploy tailored cybersecurity tools and strategies, including endpoint protection and perimeter security.
                                                        </p>
                                                    </div>
                                                </div>
                                                <div className="content_box_cn  style_one">
                                                    <div className="txt_content">
                                                        <h3>
                                                            <Link href="#" >Monitoring & Optimizing Security</Link>
                                                        </h3>
                                                        <p>Provide ongoing monitoring, regular audits, and updates to ensure continued protection against evolving threats.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="widgets_grid_box">
                                        <div className="widget creote_widget_service_list">
                                            ...
                                            <ul className="service_list_box">
                                                <li><Link href="#">1. Vulnerability Assessment & Penetration Testing</Link> </li>
                                                <li><Link href="#">2. Endpoint Protection</Link> </li>
                                                <li><Link href="#">3. Incident Response & Data Recovery</Link> </li>
                                                <li><Link href="#">4. IT & Security Audits</Link> </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div className="widgets_grid_box">
