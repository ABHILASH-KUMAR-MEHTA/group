...
export default function ServiceDetails() {
    ...
    return (
        <>
            <Layout breadcrumbTitle="Tailored Software Solutions">
                <div>
                                    ...
                                    <article className="clearfix service type-service status-publish has-post-thumbnail hentry">
                                        <div className="title_all_box style_one dark_color">
                                            <div className="title_sections left">
                                                <div className="before_title">Empowering Businesses with Custom Software for Enhanced Efficiency</div>
                                                {/* <div className="title">Our Service</div> */}
                                                <p>At Nidham Consultancy LLC, we design tailored software solutions that address your unique business challenges. From automating repetitive tasks to streamlining complex workflows, our custom applications are crafted to enhance productivity, support strategic decisions, and drive measurable results.
                                                </p>
                                            </div>
                                        </div>
                                        <div className="row no-space">
                                            <div className="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-5 mb-lg-5 mb-xl-0 ps-0 ps-lg-0 pe-0 pe-lg-0 pe-xl-3">
                                                ...
                                                <div className="icon_box_all style_one">
                                                    <div className="icon_content ">
                                                        ...
                                                        <div className="txt_content">
                                                            <h3>
                                                                <Link href="#" >Streamlined Business Processes</Link>
                                                            </h3>
                                                            <p>Automate workflows and reduce manual intervention, saving time and minimizing errors.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                {/*===============spacing==============*/}
                                                ...
                                                <div className="simple_image_boxes">
                                                    <img src="/assets/images/tailored-software.jpg" className="object-fit-cover-center height_570px" alt="image" />
                                                </div>
                                            </div>
                                            <div className="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-xs-12 ps-0 ps-lg-0 pe-0 pe-lg-0 ps-xl-3">
                                                <div className="icon_box_all style_one">
                                                    <div className="icon_content ">
                                                        ...
                                                        <div className="txt_content">
                                                            <h3>
                                                                <Link href="#" >Data-Driven Insights</Link>
                                                            </h3>
                                                            <p>Leverage advanced analytics to make informed decisions and support your strategic objectives.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                {/*===============spacing==============*/}
                                                ...
                                                <div className="icon_box_all style_one">
                                                    <div className="icon_content ">
                                                        ...
                                                        <div className="txt_content">
                                                            <h3>
                                                                <Link href="#" >Scalable and Future-Ready Software</Link>
                                                            </h3>
                                                            <p>Develop systems designed to adapt to your business growth and evolving market demands.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                {/*===============spacing==============*/}
                                                ...
                                                <div className="content_box_cn style_one">
                                                    <div className="txt_content">
                                                        <h3>
                                                            <Link href="#" >Understanding Business Needs</Link>
                                                        </h3>
                                                        <p>Conduct an in-depth analysis of your operational challenges and requirements to design tailored software solutions.</p>
                                                    </div>
                                                </div>
                                                <div className="content_box_cn  style_one">
                                                    <div className="txt_content">
                                                        <h3>
                                                            <Link href="#" >Developing and Deploying Solutions</Link>
                                                        </h3>
                                                        <p>Build and implement software systems that seamlessly integrate with your existing infrastructure, ensuring minimal disruption
                                                        </p>
                                                    </div>
                                                </div>
                                                <div className="content_box_cn  style_one">
                                                    <div className="txt_content">
                                                        <h3>
                                                            <Link href="#" >Continuous Optimization and Support</Link>
                                                        </h3>
                                                        <p>Provide ongoing monitoring, updates, and enhancements to ensure your software remains efficient and aligned with your goals.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="widgets_grid_box">
                                        <div className="widget creote_widget_service_list">
                                            ...
                                            <ul className="service_list_box">
                                                <li><Link href="#">1. Custom Software Development</Link> </li>
                                                <li><Link href="#">2. ERP Implementation</Link> </li>
                                                <li><Link href="#">3. Cashflow & Treasury Solutions</Link> </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div className="widgets_grid_box">
